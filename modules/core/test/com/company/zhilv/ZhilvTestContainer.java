...
public class ZhilvTestContainer extends TestContainer {

    public ZhilvTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/zhilv/app.properties",
    ...
    public static class Common extends ZhilvTestContainer {

        public static final ZhilvTestContainer.Common INSTANCE = new ZhilvTestContainer.Common();
